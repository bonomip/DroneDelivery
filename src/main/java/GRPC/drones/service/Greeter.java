...
public class Greeter {
    ...
    private static void onError(ManagedChannel channel, RingList friends, int drone_id){
    ...
    private static void sendGreetingsToAll(RingList friends, Drone me, int[] myPosition) throws InterruptedException {
    ...
    public static void joinOverlayNetwork(RingList friends, Drone me, int[] myPosition) throws InterruptedException, IOException {
